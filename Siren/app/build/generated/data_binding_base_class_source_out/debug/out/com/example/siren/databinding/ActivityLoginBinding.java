...
public final class ActivityLoginBinding implements ViewBinding {
  ...
  private ActivityLoginBinding(@NonNull ConstraintLayout rootView, @NonNull ImageButton btnGoogle,
      @NonNull Button btnLogin, @NonNull TextView btnRegister, @NonNull EmailEditText etEmail,
  ...
  public static ActivityLoginBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ActivityLoginBinding((ConstraintLayout) rootView, btnGoogle, btnLogin, btnRegister,
          etEmail, etPassword, ivLogin, linearLayout1, tvAcc, tvInputLogin, tvLogin, tvLoginGoogle,
          viewLine1, viewLine2);
    }
